...
SELECT i, w,
    ...
    substring(md5(i::text || '01'), 1, 24),
    substring(md5(i::text || '02'), 1, 24),
    substring(md5(i::text || '03'), 1, 24),
    substring(md5(i::text || '04'), 1, 24),
    substring(md5(i::text || '05'), 1, 24),
    substring(md5(i::text || '06'), 1, 24),
    substring(md5(i::text || '07'), 1, 24),
    substring(md5(i::text || '08'), 1, 24),
    substring(md5(i::text || '09'), 1, 24),
    substring(md5(i::text || '10'), 1, 24),
    0, 0, 0,
