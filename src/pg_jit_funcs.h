...
typedef enum JitInlineOp
{
	...
	JIT_INLINE_UINT8_EQ, JIT_INLINE_UINT8_NE,
	JIT_INLINE_UINT8_LT, JIT_INLINE_UINT8_LE,
	JIT_INLINE_UINT8_GT, JIT_INLINE_UINT8_GE,
	JIT_INLINE_UINT32_EQ, JIT_INLINE_UINT32_NE,
	JIT_INLINE_UINT32_LT, JIT_INLINE_UINT32_LE,
	JIT_INLINE_UINT32_GT, JIT_INLINE_UINT32_GE,
	JIT_INLINE_UINT64_EQ, JIT_INLINE_UINT64_NE,
	JIT_INLINE_UINT64_LT, JIT_INLINE_UINT64_LE,
	JIT_INLINE_UINT64_GT, JIT_INLINE_UINT64_GE,
	...
	/* three-way comparisons returning -1, 0, or 1 */
	JIT_INLINE_BOOL_CMP3,   /* (a != 0) - (b != 0) */
	JIT_INLINE_INT8_CMP3,   /* (a > b) - (a < b), signed */
 ...
 * Hash lookup built once per backend process.
 */
...
/* Compile-time extract/date_part — resolve unit string to enum, extract field */
extern int32 jit_resolve_timestamp_field(int64 unit_datum);
extern int64 jit_extract_timestamp(int64 ts, int32 field_val);
extern int64 jit_datepart_timestamp(int64 ts, int32 field_val);

/* Fast-path aggregate transition helpers (called from AGG_TRANS handler) */
extern int32 jit_numeric_agg_trans_fast(int64 state_ptr, int64 numeric_datum);
extern int32 jit_int_numeric_accum_fast(int64 state_ptr, int64 intval);
extern void jit_float8_accum_fast(int64 array_ptr, int64 newval_datum,
                                  int32 is_float4);
#ifdef PG_INT128_TYPE
extern int32 jit_int128_accum_fast(int64 state_ptr, int64 newval);
extern int32 jit_int128_accum_x2_fast(int64 state_ptr, int64 newval);
#endif
extern int32 jit_numeric_minmax_fast(int64 current_datum, int64 new_datum,
                                     int32 is_min);
